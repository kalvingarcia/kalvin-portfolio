 ...
 * 
 * @param props The Animator takes 5 props:
...
export default function Animator({show = false, enter, exit, duration = DEFAULT_ANIMATION_DURATION, children}) {
    try {
        ...
        useEffect(() => {
            setChild(Children.only(children));
        }, [children]);
        useEffect(() => {
        ...
        console.error(error.message === ENTER_EXIT_ERROR_MESSAGE? ENTER_EXIT_ERROR_MESSAGE : CHILDREN_ERROR_MESSAGE);
        return <></>;
    }
}